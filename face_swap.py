...
def face_swap(img_path, img2_path, *parts_to_swap, visDebug = False, cropImg = False):
    ...
    with open("output.txt", "a") as output_file:
        message = "Detecting landmarks Source Image...\n"
    ...
    with open("output.txt", "a") as output_file:
        message = "Deforming 3DMM Source Image...\n"
        output_file.write(message)
    ...
    with open("output.txt", "a") as output_file:
        message = "Segmenting Source Image...\n"
        output_file.write(message)
    ...
    with open("output.txt", "a") as output_file:
        message = "Detecting landmarks Target Image...\n"
        output_file.write(message)
    lm_dst = detect_landmarks(img2, fa)

    #print("Deforming 3DMM Target Image...")
    with open("output.txt", "a") as output_file:
        message = "Deforming 3DMM Target Image...\n"
        output_file.write(message)
    ...
    for lm_points, accepted_idx in zip(landmarks_points, accepted_indexes):
        ...
        with open("output.txt", "a") as output_file:
            message = "Extracting Triangulation...\n"
            output_file.write(message)
